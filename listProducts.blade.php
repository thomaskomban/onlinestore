...
<div>
    ...
    <table class="table table-bordered table-striped">
        <thead>
            <tr>
                @foreach(db_fieldnames($products, false) as $field)
                <th>{{$field}}</th>
                @endforeach
        ...
        <tbody>
            @foreach(db_records($products, false) as $ky=>$vl)
            <tr>
                @foreach($vl as $c=>$r)
                <td>{{$r}}</td>
                @endforeach
                <td class="text-center">
                    <a href="{{ url('/admin/producte') . '/' . $vl['id'] }}" class="btn btn-primary btn-sm">
                ...
                <td class="text-center">
                    <a href="{{ url('/admin/productd') . '/' . $vl['id'] }}" class="btn btn-primary btn-sm">
