...
<div>
    ...
    <form class="needs-validation" method="POST" action="{{route('category.add')}}" novalidate>
        @csrf
        <div class="form-row">
            <div class="input-group mb-3">
                ...
                <input type="text" name="category_name" class="form-control" aria-label="Category Name" aria-describedby="basic-addon1">
            </div>
        </div>
        <div class="form-row">
            <div class="input-group mb-3">
