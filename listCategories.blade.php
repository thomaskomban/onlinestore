...
<div>
    ...
    <table class="table table-bordered table-striped">
        <thead>
            <tr>
                @foreach(db_fieldnames($categories, true) as $field)
                <th>{{$field}}</th>
        ...
        <tbody>
            @foreach(db_records($categories, true) as $ky=>$vl)
            <tr>
                @foreach($vl as $c=>$r)
                <td>{{$r}}</td>
                @endforeach
                <td class="text-center">
                    <a href="{{ url('/admin/categorye') . '/' . $vl['id'] }}" class="btn btn-primary btn-sm">
                ...
                <td class="text-center">
                    <a href="{{ url('/admin/categoryd') . '/' . $vl['id'] }}" class="btn btn-primary btn-sm">
